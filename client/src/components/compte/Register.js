...
import { Backdrop, Breadcrumbs, Card, CardContent, CardMedia, FormControl, FormHelperText, IconButton, InputLabel, MenuItem, Select } from '@mui/material';
...
export default function Register() {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        alert === false && show ===true? setLoading(false) : setLoading(true)

        console.log(user)
        dispatch(Registration(user, history, setAlert,setLoading))
        setShow(false)
    }
    return (
        <>
