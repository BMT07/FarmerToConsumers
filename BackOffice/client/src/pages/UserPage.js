...
import { Alert, AlertTitle, Box, styled, TableBody, tableCellClasses, CircularProgress, InputBase, Grid, TableCell, Table, TableContainer, TableHead, TableRow, Paper, Button, IconButton, TablePagination, TextField } from '@mui/material';
              ...
              <TableBody >
                ...
                {filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item, index) => (
                  <StyledTableRow key={index}>
                    ...
                    <StyledTableCell>
                      <IconButton aria-label="edit" onClick={() => navigate(`/dashboard/modif/${item._id}`)} color="success">
                        <Edit />
                      </IconButton>
                      <IconButton aria-label="delete" color="error" onClick={() => handleDelete(item._id)} >
                        <Delete />
                      </IconButton>
                      <IconButton aria-label="view" onClick={() => navigate(`/dashboard/detail/${item._id}`)} color="primary">
                        <Visibility />
                      </IconButton>
                    </StyledTableCell>
                  </StyledTableRow>
