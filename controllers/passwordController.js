...
const { User, validateChangePassword } = require("../models/users.models");
 ...
 *  @access  public
 */
module.exports.sendForgotPasswordLink = asyncHandler(async (req, res, next) => {
  ...
  transporter.sendMail(mailOptions, function(error, success){
    if(error){
      ...
      // res.status(500).json({message: "something went wrong with email sending"});
